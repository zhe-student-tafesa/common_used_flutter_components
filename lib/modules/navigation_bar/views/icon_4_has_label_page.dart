...
class Icon4HasLabelPage extends StatefulWidget {
  const Icon4HasLabelPage({Key? key}) : super(key: key);

  @override
  State<Icon4HasLabelPage> createState() => _Icon4HasLabelPageState();
}

class _Icon4HasLabelPageState extends State<Icon4HasLabelPage> {
  int currentPageIndex = 0;
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text(FZStrings.icon4HasLabel),
